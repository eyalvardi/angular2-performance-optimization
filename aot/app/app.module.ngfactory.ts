...
import * as import30 from './demos/home.component.ngfactory';
import * as import31 from './demos/accordion/demo.component.ngfactory';
import * as import32 from './demos/board/board.demo.component.ngfactory';
import * as import33 from './demos/board/board2.demo.component.ngfactory';
import * as import34 from './demos/detach/users-demo.component.ngfactory';
import * as import35 from './demos/on-dirty/on-dirty.component.ngfactory';
...
import * as import44 from '../../app/demos/home.component';
import * as import45 from '../../app/demos/accordion/demo.component';
import * as import46 from '../../app/demos/board/board.demo.component';
import * as import47 from '../../app/demos/board/board2.demo.component';
import * as import48 from '../../app/demos/detach/users-demo.component';
import * as import49 from '../../app/demos/on-dirty/on-dirty.component';
...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __Location_40:import24.Location;
  __UrlSerializer_41:import25.DefaultUrlSerializer;
  __RouterOutletMap_42:import26.RouterOutletMap;
  __NgModuleFactoryLoader_43:import27.SystemJsNgModuleLoader;
  __ROUTES_44:any[];
  __Router_45:any;
  __ActivatedRoute_46:any;
  _NoPreloading_47:import28.NoPreloading;
  _PreloadingStrategy_48:any;
  _RouterPreloader_49:import28.RouterPreloader;
  __PreloadAllModules_50:import28.PreloadAllModules;
  ...
  get _APP_ID_16():any {
    if ((this.__APP_ID_16 == (null as any))) { (this.__APP_ID_16 = import37._appIdRandomProviderFactory()); }
  ...
  get _EventManager_20():import14.EventManager {
    if ((this.__EventManager_20 == (null as any))) { (this.__EventManager_20 = new import14.EventManager(this._EVENT_MANAGER_PLUGINS_19,this.parent.get(import40.NgZone))); }
  ...
  get _RootRenderer_24():any {
    if ((this.__RootRenderer_24 == (null as any))) { (this.__RootRenderer_24 = import41._createConditionalRootRenderer(this._DomRootRenderer_23,this.parent.get(import41.NgProbeToken,(null as any)))); }
  ...
  get _BrowserXhr_32():import20.BrowserXhr {
    if ((this.__BrowserXhr_32 == (null as any))) { (this.__BrowserXhr_32 = new import20.BrowserXhr()); }
    return this.__BrowserXhr_32;
  }
  get _ResponseOptions_33():import21.BaseResponseOptions {
    if ((this.__ResponseOptions_33 == (null as any))) { (this.__ResponseOptions_33 = new import21.BaseResponseOptions()); }
    return this.__ResponseOptions_33;
  }
  get _XSRFStrategy_34():any {
    if ((this.__XSRFStrategy_34 == (null as any))) { (this.__XSRFStrategy_34 = import5._createDefaultCookieXSRFStrategy()); }
    return this.__XSRFStrategy_34;
  }
  get _XHRBackend_35():import22.XHRBackend {
    if ((this.__XHRBackend_35 == (null as any))) { (this.__XHRBackend_35 = new import22.XHRBackend(this._BrowserXhr_32,this._ResponseOptions_33,this._XSRFStrategy_34)); }
    return this.__XHRBackend_35;
  }
  get _RequestOptions_36():import23.BaseRequestOptions {
    if ((this.__RequestOptions_36 == (null as any))) { (this.__RequestOptions_36 = new import23.BaseRequestOptions()); }
    return this.__RequestOptions_36;
  }
  get _Http_37():any {
    if ((this.__Http_37 == (null as any))) { (this.__Http_37 = import5.httpFactory(this._XHRBackend_35,this._RequestOptions_36)); }
    return this.__Http_37;
  }
  get _ROUTER_CONFIGURATION_38():any {
    if ((this.__ROUTER_CONFIGURATION_38 == (null as any))) { (this.__ROUTER_CONFIGURATION_38 = {useHash: true}); }
    return this.__ROUTER_CONFIGURATION_38;
  }
  get _LocationStrategy_39():any {
    if ((this.__LocationStrategy_39 == (null as any))) { (this.__LocationStrategy_39 = import6.provideLocationStrategy(this.parent.get(import42.PlatformLocation),this.parent.get(import43.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_38)); }
    return this.__LocationStrategy_39;
  }
  get _Location_40():import24.Location {
    if ((this.__Location_40 == (null as any))) { (this.__Location_40 = new import24.Location(this._LocationStrategy_39)); }
    return this.__Location_40;
  }
  get _UrlSerializer_41():import25.DefaultUrlSerializer {
    if ((this.__UrlSerializer_41 == (null as any))) { (this.__UrlSerializer_41 = new import25.DefaultUrlSerializer()); }
    return this.__UrlSerializer_41;
  }
  get _RouterOutletMap_42():import26.RouterOutletMap {
    if ((this.__RouterOutletMap_42 == (null as any))) { (this.__RouterOutletMap_42 = new import26.RouterOutletMap()); }
    return this.__RouterOutletMap_42;
  }
  get _NgModuleFactoryLoader_43():import27.SystemJsNgModuleLoader {
    if ((this.__NgModuleFactoryLoader_43 == (null as any))) { (this.__NgModuleFactoryLoader_43 = new import27.SystemJsNgModuleLoader(this._Compiler_15,this.parent.get(import27.SystemJsNgModuleLoaderConfig,(null as any)))); }
  ...
  get _Router_45():any {
    if ((this.__Router_45 == (null as any))) { (this.__Router_45 = import6.setupRouter(this._ApplicationRef_14,this._UrlSerializer_41,this._RouterOutletMap_42,this._Location_40,this,this._NgModuleFactoryLoader_43,this._Compiler_15,this._ROUTES_44,this._ROUTER_CONFIGURATION_38)); }
    return this.__Router_45;
  }
  get _ActivatedRoute_46():any {
    if ((this.__ActivatedRoute_46 == (null as any))) { (this.__ActivatedRoute_46 = import6.rootRoute(this._Router_45)); }
    return this.__ActivatedRoute_46;
  }
  get _PreloadAllModules_50():import28.PreloadAllModules {
    if ((this.__PreloadAllModules_50 == (null as any))) { (this.__PreloadAllModules_50 = new import28.PreloadAllModules()); }
    return this.__PreloadAllModules_50;
  }
  get _APP_BOOTSTRAP_LISTENER_51():any[] {
    if ((this.__APP_BOOTSTRAP_LISTENER_51 == (null as any))) { (this.__APP_BOOTSTRAP_LISTENER_51 = [import6.initialRouterNavigation(this._Router_45,this._ApplicationRef_14,this._RouterPreloader_49,this._ROUTER_CONFIGURATION_38)]); }
  ...
  createInternal():import1.AppModule {
    ...
    this._ROUTER_FORROOT_GUARD_4 = import6.provideForRootGuard(this.parent.get(import50.Router,(null as any)));
    ...
    this._ApplicationRef__13 = new import11.ApplicationRef_(this.parent.get(import40.NgZone),this.parent.get(import51.Console),this,this._ErrorHandler_10,this,this._ApplicationInitStatus_11,this.parent.get(import10.TestabilityRegistry,(null as any)),this._Testability_12);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import52.LOCALE_ID)) { return this._LOCALE_ID_8; }
    if ((token === import8.NgLocalization)) { return this._NgLocalization_9; }
    if ((token === import53.ErrorHandler)) { return this._ErrorHandler_10; }
    ...
    if ((token === import37.APP_ID)) { return this._APP_ID_16; }
    if ((token === import54.DOCUMENT)) { return this._DOCUMENT_17; }
    ...
    if ((token === import55.AnimationDriver)) { return this._AnimationDriver_22; }
    if ((token === import16.DomRootRenderer)) { return this._DomRootRenderer_23; }
    if ((token === import56.RootRenderer)) { return this._RootRenderer_24; }
    if ((token === import17.DomSanitizer)) { return this._DomSanitizer_25; }
    if ((token === import57.Sanitizer)) { return this._Sanitizer_26; }
    if ((token === import18.ViewUtils)) { return this._ViewUtils_27; }
    if ((token === import58.IterableDiffers)) { return this._IterableDiffers_28; }
    if ((token === import59.KeyValueDiffers)) { return this._KeyValueDiffers_29; }
    ...
    if ((token === import60.XSRFStrategy)) { return this._XSRFStrategy_34; }
    if ((token === import22.XHRBackend)) { return this._XHRBackend_35; }
    if ((token === import23.RequestOptions)) { return this._RequestOptions_36; }
    if ((token === import61.Http)) { return this._Http_37; }
    if ((token === import6.ROUTER_CONFIGURATION)) { return this._ROUTER_CONFIGURATION_38; }
    if ((token === import43.LocationStrategy)) { return this._LocationStrategy_39; }
    if ((token === import24.Location)) { return this._Location_40; }
    if ((token === import25.UrlSerializer)) { return this._UrlSerializer_41; }
    if ((token === import26.RouterOutletMap)) { return this._RouterOutletMap_42; }
    if ((token === import62.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_43; }
    if ((token === import63.ROUTES)) { return this._ROUTES_44; }
    if ((token === import50.Router)) { return this._Router_45; }
    if ((token === import64.ActivatedRoute)) { return this._ActivatedRoute_46; }
    if ((token === import28.NoPreloading)) { return this._NoPreloading_47; }
    if ((token === import28.PreloadingStrategy)) { return this._PreloadingStrategy_48; }
    if ((token === import28.RouterPreloader)) { return this._RouterPreloader_49; }
    if ((token === import28.PreloadAllModules)) { return this._PreloadAllModules_50; }
    if ((token === import37.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_51; }
