...
import { Component, ElementRef, Renderer, NgZone, ChangeDetectorRef, ApplicationRef } from "@angular/core";
...
var BoardDemo2Component = (function (_super) {
    ...
    function BoardDemo2Component(elmRef, render, zone, cd, appRef) {
        var _this = _super.call(this, elmRef, render, zone, cd, appRef) || this;
        _this.elmRef = elmRef;
        _this.render = render;
        _this.zone = zone;
        _this.cd = cd;
        _this.appRef = appRef;
        _this.counters = new Array(100);
        _this.value = 0;
        _this.isRun = false;
